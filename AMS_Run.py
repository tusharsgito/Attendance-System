...
def manually_fill():
    ...
    def fill_attendance():
        ...
        global subb
        subb = SUB_ENTRY.get()
        DB_table_name = str(subb + "_" + Date + "_Time_" +0+
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = "C:/project/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/"+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                csv_name = "C:/project/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/" + DB_table_name + ".csv"
                subprocess.Popen('explorer /select,' + csv_name)
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = "C:/project/Face-Recognition-Attendance-System-main/" + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/project/Face-Recognition-Attendance-System-main/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'admin':
            if password == '123':
                ...
                cs = "C:/project/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv"
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
